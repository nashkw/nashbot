...
def get_table(blist, head=None, block=True, trunc=False, bords=True):
    if trunc:
        blist = [[str(col)[:trunc-3] + '...' if len(str(col)) > trunc else col for col in row] for row in blist]
    table = table2ascii(
        header=head,
        body=blist,
...
# quotes for debug commands

latest_names = [
    'only latest',
    'only latest folder',
    'only latest download',
    'only latest downloads',
    'only latest downloaded',
    'latest',
    'latest download',
    'latest downloads',
    'latest folder',
    ...
    'recent folder',
    'most recent folder',
    'most recently made folder',
    'most recently created',
    'only new',
    'only new folder',
    'only new download',
    'only new downloads',
    'only newly downloaded',
    'only newest',
    'only newest folder',
    'only newest download',
    'only newest downloads',
    'only newest downloaded',
    'new',
    'new download',
    'new downloads',
    'newly downloaded',
    ...
    'only prev download',
    'only prev downloads',
    'only prev downloaded',
    'only previous',
    'only previous folder',
    'only previous download',
    'only previous downloads',
